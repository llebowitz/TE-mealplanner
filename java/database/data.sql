...
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 1, 1, 'small, grated');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 2, 1.5, 'tablespoons');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 3, 3, 'tablespoons, grated, lightly packed');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 4, 3, 'tablespoons');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 5, 1, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 6, 1, 'medium size, cored and cut into matchsticks');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 7, .5, 'small root, peeled, cut into matchsticks');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 8, 1, 'medium bulb trimmed, thinly sliced');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 9, .5, 'cup, chopped');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 10, .25, 'cup, chopped');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 11, .5, 'cup, toasted and rough chopped');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 12, 1, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (1, 13, .5, 'teaspoon');
...
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 14, 8, 'ounces, grated');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 15, 2, 'tablespoons');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 16, 2, 'tablespoons');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 13, .5, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 17, .25, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 18, 1, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 19, 1, 'teaspoon');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 20, 1, 'cup');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 21, 4, 'slices, cut thick');
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, amount, measurement) VALUES (2, 22, 2, 'tablespoons, minced');
