<template>
  <div>
      ...
      <h1>Grocery List</h1>
        ...
        <label v-for="ingredient in groceryList" v-bind:key="ingredient.id"> <input type="checkbox" v-bind:checked="textDecoration=line-through" > {{ingredient.name}} <br> </label>
